...
A more simple repo from original [LoRA](https://github.com/microsoft/LoRA)

Please follow the instructions in `NLG` to reproduce the result.
## Repository Overview
...
* [NLG/](examples/NLG) contains an example implementation of LoRA in GPT-2 using our package, which can be used to reproduce the result in our paper;
